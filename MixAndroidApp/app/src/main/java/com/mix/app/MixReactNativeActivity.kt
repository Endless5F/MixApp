...
class MixReactNativeActivity : AppCompatActivity(), DefaultHardwareBackBtnHandler {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mainReactPackages = mutableListOf<ReactPackage>()
        mainReactPackages.add(MainReactPackage())
        mReactInstanceManager = ReactInstanceManager.builder()
            .setApplication(application)
            .setCurrentActivity(this)
            .setBundleAssetName("index.android.bundle")
            .setJSMainModulePath("index")
            .addPackages(mainReactPackages)
        ...
        mReactRootView?.startReactApplication(mReactInstanceManager, "MixReactNativeApp", null)
